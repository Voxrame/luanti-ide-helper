...
-- Authentication:
--   see ./core_namespace/authentication.lua

-- Chat:
--   see ./core_namespace/chat.lua
...
-- Inventory:
--   see ./core_namespace/inventory.lua

-- Formspec:
--   see ./core_namespace/formspec.lua

-- Item handling:
--   see ./core_namespace/item_handling.lua

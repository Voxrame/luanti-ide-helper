...
--- @param vel Position e.g. `{x=0.0, y=2.3, z=1.0}` or `vector.new(0.0, 2.3, 1.0)`
function Entity:set_velocity(vel) end

--- @param acc Position e.g. `{x=0.0, y=2.3, z=1.0}` or `vector.new(0.0, 2.3, 1.0)`
...
--- @param rot Position (radians). X is pitch (elevation), Y is yaw (heading) and Z is roll (bank).

...
local NodeDefinition = {
	...
	--- Not called for bulk node placement.
	--- default: nil
	--- @type fun(pos:MapVector, old_node)?
	after_destruct                = nil,
	...
	--- Default: nil
	--- Warning: making a liquid node 'floodable' will cause problems.
	--- @type fun(pos:MapVector, old_node, new_node)?
	on_flood                      = nil,
	...
	--- default: nil
	--- @type fun(pos:MapVector, old_node, new_node, old_meta, drops:ItemStack[])?
	...
	--- default: nil
	--- @type (fun(pos:MapVector, placer:Player|ObjectRef|nil, itemstack:ItemStack, pointed_thing:pointed_thing):true?)?
	...
	--- default: nil
	--- @type fun(pos:MapVector, player:Player|ObjectRef|nil)?
	can_dig                       = nil,

	--- default: core.node_punch
	--- Called when puncher (an ObjectRef) punches the node at pos.
	--- By default calls core.register_on_punchnode callbacks.
	--- @type fun(pos:MapVector, node:NodeTable, puncher:Player|ObjectRef|nil, pointed_thing:pointed_thing)?
	on_punch                      = nil,
	...
	--- @type (fun(pos:MapVector, node:NodeTable, clicker:Player|ObjectRef, itemstack:ItemStack, pointed_thing:pointed_thing|nil):ItemStack|nil)?
	...
	--- @type (fun(pos:MapVector, node:NodeTable, digger:Player): boolean)?
	on_dig                        = nil,
	...
	--- value.
	--- @type (fun(pos:MapVector, elapsed:number): boolean)?
	on_timer                      = nil,
	...
	--- default: nil
	--- @type fun(pos:MapVector, formname:string, fields:table, sender:Player)?
	on_receive_fields             = nil,

	--- Called when a player wants to move items inside the inventory.
	--- Return value: number of items allowed to move.
	--- @type (fun(pos:MapVector, from_list:string, from_index:number, to_list:string, to_index:number, count:number, player:Player): number)?
	allow_metadata_inventory_move = nil,

	--- Called when a player wants to put something into the inventory.
	--- Return value: number of items allowed to put.
	--- Return value -1: Allow and don't modify item count in inventory.
	--- @type (fun(pos:MapVector, listname:string, index:number, stack:ItemStack, player:Player): number)?
	...
	--- allowed.
	--- No return value.
	--- @type (fun(pos:MapVector, from_list:string, from_index:number, to_list:string, to_index:number, count:number, player:Player): void)?
	on_metadata_inventory_move    = nil,
	--- Called after the actual action has happened, according to what was
	--- allowed.
	--- No return value.
	--- @type (fun(pos:MapVector, listname:string, index:number, stack:ItemStack, player:Player): void)?
	...
	--- removing the node.
	--- @type (fun(pos:MapVector, intensity?:number): void)?
	on_blast                      = nil,
